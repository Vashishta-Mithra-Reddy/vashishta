      ...
      <section id="contact" className="py-20 bg-gradient-to-b from-gray-900 to-black text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center space-y-4">
            ...
            <p>Phone: <a href="tel:+919948680040" className="text-blue-400 hover:text-blue-300 transition-colors duration-300">+91 9948680040</a></p>
            <p>Languages: Telugu, English, Hindi, Japanese</p>
          </div>
        </div>
      </section>
    )
